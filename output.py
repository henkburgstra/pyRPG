...
class Output(object):
    ...
    GEAR_SORT = ['wpn', 'shd', 'hlm', 'arm', 'clk', 'glv', 'blt', 'bts']
    INV_SORT = ['weapon', 'shield', 'helmet', 'armor', 'cloak', 'gloves', 'belt', 'boots']
    DECO_SORT = ['weapons', 'shields', 'helmets', 'armors', 'cloaks', 'gloves', 'belts', 'boots']
