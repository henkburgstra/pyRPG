...
RESOURCES_DIR = '../resources/maps/area01'

HERO_MOVE_SPEED = 200  # pixels per second
MAP_FILENAME = 'new.tmx'
...
class QuestGame(object):
    ...
    def __init__(self):
        ...
        self.walls = []
        for object1 in tmx_data.objects:
            self.walls.append(pygame.Rect(object1.x, object1.y, object1.width, object1.height))
        ...
        self.map_layer = pyscroll.BufferedRenderer(map_data, (w, h), clamp_camera=True)
